        ...
        <v-card-actions class="mt-2">
          <v-row>
            <v-col cols="12" sm="6" md="6" lg="6" class="d-inline-flex justify-center justify-sm-end justify-md-end">
              <v-btn variant="tonal" class="font-weight-black text-h6 mt-1 white button rounded-pill" style="color: black;" :href="PYAS.downloadLink"> 立即下载➞ </v-btn>
            </v-col>
  ...
  data() {
    return {
      PYAS: {
        version: '2.8.9',
        date: '2023/10/27',
        downloadLink: "https://ghproxy.com/github.com/87owo/PYAS/releases/download/v2.8.9/PYAS_Setup.exe",
        downloadLink2: "https://ghproxy.com/github.com/87owo/PYAS/releases/download/v2.8.9/PYAS.zip",
